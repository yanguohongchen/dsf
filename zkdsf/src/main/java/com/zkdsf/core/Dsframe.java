...
//		  registerServer(zkInfo, zkClient);
	...
	private void registerServer(ZkInfo zkInfo, ZkClient zkClient) throws IOException
	{
		try
		{
			...
			serveiceInstanceInfo.setIp("1.1.1.1");
	...
	public static void main(String[] args)
	{
		...
		zkInfo.setConnectAddr("192.168.253.166:2181");
